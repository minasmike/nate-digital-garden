...
export default function AboutPage() {
  return (
    <>
      ...
      <main className="container flex flex-col items-center justify-center min-h-screen px-4 py-16 mx-auto bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
        <div className="w-full max-w-2xl p-8 border shadow-xl bg-white/90 dark:bg-slate-900/90 rounded-2xl md:p-12 border-slate-200 dark:border-slate-700">
